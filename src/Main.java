...
public class Main {
    ...
    public static void main(String[] args)
    {
        Repository<Long,User> repo =
                new UserDbRepository("jdbc:postgresql://localhost:5432/academic","postgres","1234567",new UserValidator());
        Repository<Tuple<Long,Long>, Friendship> repofriends =
                new FriendshipDbRepository("jdbc:postgresql://localhost:5432/academic","postgres","1234567", new FriendshipValidator());
